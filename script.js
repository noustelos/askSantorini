const translations = {
  en: {
    ...
    conciergeIntro: "For weddings, proposals, photoshoots, private transfers and special moments in Santorini.",
    conciergePhotographersTitle: "Photographers",
    conciergePhotographersText: "Couple shoots, honeymoon sessions, family photos and sunset photography.",
    conciergeWeddingTitle: "Wedding Planners",
    conciergeWeddingText: "Planning support for weddings, elopements and symbolic ceremonies.",
    conciergeFlowersTitle: "Flowers & Decoration",
    conciergeFlowersText: "Bouquets, ceremony styling, proposal setups and event decoration.",
    conciergeTransfersTitle: "Helicopter & Premium Transfers",
    conciergeTransfersText: "Private arrivals, island transfers and luxury travel options through licensed providers.",
    conciergeBeautyTitle: "Hair & Makeup",
    conciergeBeautyText: "Beauty services for weddings, photoshoots and special evenings.",
    conciergeProposalTitle: "Proposal Planning",
    conciergeProposalText: "Romantic setups, sunset moments and private experiences.",
  ...
  el: {
    ...
    conciergeIntro: "Για γάμους, προτάσεις γάμου, φωτογραφίσεις, ιδιωτικές μεταφορές και ξεχωριστές στιγμές στη Σαντορίνη.",
    conciergePhotographersTitle: "Φωτογράφοι",
    conciergePhotographersText: "Φωτογραφίσεις για ζευγάρια, honeymoon, οικογένειες και ηλιοβασίλεμα.",
    conciergeWeddingTitle: "Wedding Planners",
    conciergeWeddingText: "Οργάνωση γάμων, elopements και συμβολικών τελετών στη Σαντορίνη.",
    conciergeFlowersTitle: "Άνθη & Διακόσμηση",
    conciergeFlowersText: "Ανθοδέσμες, στολισμοί τελετών, proposal setups και διακόσμηση εκδηλώσεων.",
    conciergeTransfersTitle: "Ελικόπτερο & Premium Μεταφορές",
    conciergeTransfersText: "Ιδιωτικές αφίξεις, μετακινήσεις και luxury επιλογές μεταφοράς μέσω αδειοδοτημένων παρόχων.",
    conciergeBeautyTitle: "Hair & Makeup",
    conciergeBeautyText: "Υπηρεσίες ομορφιάς για γάμους, φωτογραφίσεις και ξεχωριστές βραδιές.",
    conciergeProposalTitle: "Πρόταση γάμου",
    conciergeProposalText: "Ρομαντικά setups, ηλιοβασίλεμα και ιδιωτικές εμπειρίες.",
