const translations = {
  en: {
    ...
    partnerDisclosure: "Some links may be partner recommendations. Not affiliated with Google or any official tourism authority. AI assistant using Google Gemini technology.",
    ...
    footerDisclaimer: "AskSantorini.ai is an independent visitor guide. Some links may be partner recommendations.",
  ...
  el: {
    ...
    metaDescription: "Το Ask Santorini AI είναι ένας δωρεάν έξυπνος οδηγός για επισκέπτες της Σαντορίνης. Ρώτησε για παραλίες, ηλιοβασιλέματα, εκδρομές, φαγητό, μετακινήσεις και τι να κάνεις σήμερα.",
    ogTitle: "Ask Santorini AI",
    ...
    partnerDisclosure: "Ορισμένα links είναι προτάσεις συνεργατών. Δεν υπάρχει σύνδεση με τη Google ή κάποιον επίσημο τουριστικό φορέα. Λειτουργεί με τεχνολογία Google Gemini.",
    ...
    footerDisclaimer: "Το AskSantorini.ai είναι ανεξάρτητος οδηγός επισκεπτών. Ορισμένα links είναι προτάσεις συνεργατών.",
