const translations = {
  en: {
    ...
    heroReinforce: "A local AI concierge in your pocket — ready any time, any day.",
    noAppPart: "Free.",
    noSignupPart: "No app.",
    ...
    chatSampleAnswer1: "Tell me your area, how much time you have and your mood — beach, sunset, food, a tour or something easy. I'll suggest a simple plan.",
    chatSampleQuestion2: "Best sunset spot tonight?",
    chatSampleAnswer2: "Oia is iconic but crowded. Imerovigli and Firostefani are calmer alternatives, while a sunset catamaran is a more relaxed premium experience.",
    ...
    featureBeachesLine: "Black sand, red cliffs or a calm family beach — just ask.",
    ...
    conciergeIntro: "Ask about photos, private transfers, beauty, proposals and special evenings — with the right local guidance.",
    conciergeSeoLine: "For couples, families and special moments that need calm local guidance.",
    conciergePhotographersTitle: "Want photos without the hassle?",
    ...
    conciergeProposalText: "Private sunset moments, discreet setups and the right romantic timing.",
    ...
    partnersTitle: "Be the answer when guests ask about Santorini",
    ...
    networkSupport: "More destinations are being shaped around real traveler questions.",
    ...
    cookieText: "We use cookies to improve your experience and understand what's actually helpful for visitors.",
    ...
    termsP3: "For legal or general inquiries, contact",
    menuOpen: "Open menu",
    ...
    mailSubject: "Contact AskSantorini.ai",
  ...
  el: {
    ...
    chatPlaceholder: "Ρώτα το Ask Santorini AI...",
    chatPlaceholderRotations: [
      "Καλύτερο ηλιοβασίλεμα απόψε;",
    ...
    chatSampleAnswer2: "Η Οία είναι διάσημη αλλά γεμάτη κόσμο. Το Ημεροβίγλι και το Φηροστεφάνι είναι πιο ήρεμα, ενώ το καταμαράν στο ηλιοβασίλεμα είναι μια πιο χαλαρή premium επιλογή.",
    ...
    featureFood: "Λαχτάρα για τοπική κουζίνα;",
    ...
    toursTitle: "Θέλεις μια ιδιωτική εμπειρία με σκάφος;",
    ...
    toBeFeatured: "Για προβολή, επικοινώνησε στο",
    conciergeEyebrow: "Concierge",
    toursMicroCta: "Απλά ρώτα",
    conciergeTitle: "Σχεδιάζεις μια στιγμή που πρέπει να κυλήσει ήρεμα;",
    conciergeIntro: "Ρώτησε για φωτογραφίες, ιδιωτικές μεταφορές, beauty, προτάσεις γάμου και ξεχωριστές βραδιές με τη σωστή τοπική καθοδήγηση.",
    conciergeSeoLine: "Για ζευγάρια, οικογένειες και ειδικές στιγμές που χρειάζονται ήρεμη τοπική καθοδήγηση.",
    conciergePhotographersTitle: "Θέλεις φωτογραφίες χωρίς ταλαιπωρία;",
    ...
    conciergeFlowersTitle: "Χρειάζεσαι λουλούδια ή στήσιμο;",
    conciergeFlowersText: "Ανθοδέσμες, styling τελετής και διακριτικές λεπτομέρειες για την πρόταση.",
    ...
    conciergeBeautyText: "Hair και makeup για φωτογραφίες, γάμους, προτάσεις γάμου και ξεχωριστές βραδιές.",
    conciergeProposalTitle: "Ετοιμάζεις την πρόταση;",
    conciergeProposalText: "Ιδιωτικές στιγμές στο ηλιοβασίλεμα, διακριτικό στήσιμο και ιδανικό timing για τη ρομαντική στιγμή.",
    ...
    partnersTitle: "Γίνε η απάντηση όταν οι επισκέπτες ρωτούν για τη Σαντορίνη",
    ...
    networkSupport: "Περισσότεροι προορισμοί σχεδιάζονται γύρω από πραγματικές ερωτήσεις ταξιδιωτών.",
    networkLiveBadge: "Live",
    networkSoonBadge: "Coming soon",
    earlyAccessEyebrow: "Live τώρα",
    networkMicroCta: "Απλά ρώτα",
    earlyAccessTitle: "Έτοιμος να ρωτήσεις για τη Σαντορίνη;",
    earlyAccessIntro: "Χρησιμοποίησε τον live AI οδηγό για παραλίες, ώρα ηλιοβασιλέματος, χταπόδι δίπλα στη θάλασσα, ιδιωτικές βόλτες με σκάφος ή ήρεμα ημερήσια προγράμματα.",
    ...
    cookieText: "Χρησιμοποιούμε cookies για να βελτιώσουμε την εμπειρία σου και να καταλάβουμε τι είναι πραγματικά χρήσιμο για τους επισκέπτες.",
    ...
    termsP3: "Για νομικές ή γενικές πληροφορίες, επικοινώνησε στο",
    ...
    mailSubject: "Επικοινωνία με AskSantorini.ai",
...
function getTruthLayerMissingFields(entity) {
  return truthLayerFactualFields.filter((field) => {
    if (field === "phone") return !getEntityPhoneUrl(entity);
    if (field === "website") return !getEntityWebsiteUrl(entity);
    if (field === "maps_url") return !getEntityMapsUrl(entity);
    return true;
  });
}

function hasTruthCompleteness(entity) {
  return getTruthLayerMissingFields(entity).length < truthLayerFactualFields.length;
}
...
function getSfpIntent(userMessage, selectedIntent = "", entity = null) {
  const ctaIntent = classifyCriticalUniversalCtaIntent(userMessage) || classifyUniversalCtaIntent(userMessage);

  return ctaIntent && ctaIntent !== "general_info"
    ? ctaIntent
    : String(selectedIntent || entity?.type || ctaIntent || "general_info");
}

function getSfpCtaPriority(intent) {
  if (intent === "phone") return { phone: 1, link: 2, maps: 3 };
  if (intent === "website") return { link: 1, phone: 2, maps: 3 };
  if (["location_request", "navigation_request"].includes(intent)) return { maps: 1, phone: 2, link: 3 };
  return { phone: 1, link: 2, maps: 3 };
}

function buildSfpTruthCtas(entity, intent) {
  ...
  addUniversalCta(actions, createUniversalCta("phone", "Call Now", resolvedEntity.phone, "secondary"));
  addUniversalCta(actions, createUniversalCta("link", "Visit Website", resolvedEntity.websiteUrl, "secondary"));
  addUniversalCta(actions, createUniversalCta("maps", "Open in Maps", resolvedEntity.mapsUrl, "secondary"));
...
function enforceSfpCtas({ actions = [], entity = null, intent = "", rawText = "", llmPhoneAttempt = false, fallbackTriggered = false, entityMatchConfidence = 0, entityResolutionSource = "", intentRouting = null, fallbackAttemptedOverride = false, locationFallbackTriggered = false, entityMissingLocationCase = false, fallbackPathUsed = "" } = {}) {
  ...
  actions.forEach((action) => {
    ...
    enforcedActions.push({
      type,
      label: type === "phone" ? "Call Now" : type === "link" ? "Visit Website" : "Open in Maps",
      url: expectedUrl,
  ...
  const priority = getSfpCtaPriority(intent);
  const sortedActions = enforcedActions
    .sort((a, b) => (priority[a.type] || 99) - (priority[b.type] || 99))
    .map((action, index) => ({
      ...action,
      style: index === 0 ? "primary" : "secondary"
...
function renderSfpFragment(finalResponse) {
  ...
  if (finalResponse.actions.length) {
    ...
    finalResponse.actions.forEach((action) => {
...
function appendFinalResponse(finalResponse, className = "bot-message") {
  ...
  const fragment = renderSfpFragment(finalResponse);
  ...
  askSantoriniTrafficLog("AskSantorini SFP final render:", {
    id,
    pipeline_step_log: finalResponse.pipeline_step_log,
    intent: finalResponse.intent,
    actions: finalResponse.actions,
    cta_debug: finalResponse.cta_debug,
...
function getTruthLayerFallbackMessage(missingFields = truthLayerFactualFields, { entity = null, intent = "", fallbackPathUsed = "" } = {}) {
  ...
  if (hasWebsite) alternatives.push("check the official website for the most up-to-date details");
  if (hasMaps) alternatives.push("open the verified map listing for location details");
  if (hasPhone && intent !== "phone") alternatives.push("use the verified contact number shown here");

  const nextBestAction = alternatives.length
    ? ` You can ${alternatives.slice(0, 2).join(" or ")}.`
    : fallbackPathUsed === "clarification_request"
...
function appendMessage(text, className, context = {}) {
  ...
  const isFinalBotMessage = String(className).includes("bot-message")
    && !String(className).includes("loading");

  if (isFinalBotMessage) {
    throw new Error("Final bot responses must use finalizeResponse().");
  }
...
function clampOptimizationWeight(value) {
  const bounds = conciergeOptimizationConfig.autonomous.weightBounds;
  return clampNumber(value, bounds.min, bounds.max);
}

function getDefaultOptimizationWeights() {
  return { ...conciergeOptimizationConfig.autonomous.defaultWeights };
}

function getAutonomousOptimizationState() {
  try {
    const state = JSON.parse(getStoredValue(conciergeOptimizationStorageKey) || "{}") || {};
    return {
...
function setAutonomousOptimizationState(state) {
  setStoredValue(conciergeOptimizationStorageKey, JSON.stringify(state || {}));
}

function getAffiliateOptimizationKey(affiliate) {
  return String(affiliate?.url || affiliate?.name || "").trim().toLowerCase();
}

function ensureIntentOptimizationState(state, intentType) {
  const intent = String(intentType || "general");
...
function normalizeAffiliateRow(row) {
  ...
  if (!phone && !url && !mapsUrl) {
    logDataGovernanceEvent("invalid row rejected: no valid factual fields", {
      rowNumber,
      entityId,
  ...
  return {
    entityId,
    name,
    normalizedName: normalizeEntityLookupText(name),
    type,
    ...
    mapsUrl,
    phone,
    missingFieldsList: getTruthLayerMissingFields({ phone, websiteUrl: url, mapsUrl }),
    rowNumber,
    score
  };
}
...
const greeklishPlaceAliases = [
  ...
  ["firostefani", ["firostefani", "φυροστεφανι", "φηροστεφανι"]],
  ["perissa", ["περισσα"]],
  ["perivolos", ["περιβολος"]],
  ["kamari", ["καμαρι"]]
];
...
function applyGreeklishAliases(value) {
  ...
  greeklishPlaceAliases.forEach(([canonical, aliases]) => {
    [canonical, ...aliases].forEach((alias) => {
      ...
      normalizedValue = normalizedValue.replace(pattern, canonical);
    });
  });
...
function normalizeEntityLookupText(value, { transliterate = true } = {}) {
  ...
  const greeklish = transliterate ? transliterateGreekToLatin(normalized) : normalized;

  return applyGreeklishAliases(greeklish)
    .replace(/[^a-z0-9]+/gi, " ")
    .replace(/\s+/g, " ")
    .trim();
}
...
function getLookupTokens(value) {
  return normalizeEntityLookupText(value)
    .split(" ")
...
function scoreTruthLayerEntityMatch(message, entity) {
  ...
  if (normalizedMessage.includes(normalizedName) || normalizedMessage.includes(normalizedEntityId)) return 1;
...
function normalizeTruthLayerMatchResult(entity, confidence, candidates = [], ambiguous = false) {
  return {
    entity,
    confidence: Number(confidence.toFixed(3)),
    candidates,
    ambiguous,
    fallbackTriggered: Boolean(!entity || ambiguous)
  };
}
...
function findTruthLayerEntityInMessage(message) {
  ...
  if (!normalizedMessage) return normalizeTruthLayerMatchResult(null, 0);

  const scoredMatches = conciergeAffiliates
    .map((entity) => ({
      entity,
      confidence: scoreTruthLayerEntityMatch(message, entity)
    }))
    .filter((match) => match.confidence >= 0.62)
    .sort((a, b) => {
      if (b.confidence !== a.confidence) return b.confidence - a.confidence;
      const lengthDelta = String(b.entity.name || "").length - String(a.entity.name || "").length;
      if (lengthDelta !== 0) return lengthDelta;
      if (b.entity.priority !== a.entity.priority) return b.entity.priority - a.entity.priority;
      return String(a.entity.entityId || "").localeCompare(String(b.entity.entityId || ""));
    });

  if (!scoredMatches.length) {
    return normalizeTruthLayerMatchResult(null, 0);
  }

  const [topMatch, secondMatch] = scoredMatches;
  const ambiguous = Boolean(secondMatch && topMatch.confidence < 0.98 && (topMatch.confidence - secondMatch.confidence) < 0.08);

  if (ambiguous) {
    return normalizeTruthLayerMatchResult(null, topMatch.confidence, scoredMatches.slice(0, 3).map((match) => ({
  ...
  return normalizeTruthLayerMatchResult(
    topMatch.entity,
    topMatch.confidence,
    scoredMatches.slice(0, 3).map((match) => ({
      entityId: match.entity.entityId,
      name: match.entity.name,
      confidence: Number(match.confidence.toFixed(3))
    }))
...
function getIntentOptimizationWeights(intentType) {
...
function getAffiliatePerformanceMemory(intentType, affiliate) {
  const state = getAutonomousOptimizationState();
  const intentState = ensureIntentOptimizationState(state, intentType);
  const key = getAffiliateOptimizationKey(affiliate);
...
function getIntentPerformanceStats(intentType) {
  ...
  const state = getAutonomousOptimizationState();
  const intentState = ensureIntentOptimizationState(state, intentType);
  const memoryValues = Object.values(intentState.affiliates || {});
  const memoryClicks = memoryValues.reduce((total, affiliate) => total + (Number(affiliate.clicks) || 0), 0);
  const memoryImpressions = memoryValues.reduce((total, affiliate) => total + (Number(affiliate.impressions) || 0), 0);
  const totalClicks = clicks + memoryClicks;
  const totalImpressions = impressions + memoryImpressions;
  const averageCtr = totalImpressions > 0 ? Math.min(totalClicks / (totalImpressions + 1), 1) : 0;
...
function getDriftModifier(affiliate, intentStats) {
  ...
  const memory = getAffiliatePerformanceMemory(affiliate.type, affiliate);
  const sheetImpressions = Number(affiliate.impressions) || 0;
  const memoryImpressions = Number(memory?.impressions) || 0;
  const impressions = sheetImpressions + memoryImpressions;
  const sheetClicks = Number(affiliate.clicks) || 0;
  const memoryClicks = Number(memory?.clicks) || 0;
  const combinedCtr = impressions > 0 ? Math.min((sheetClicks + memoryClicks) / (impressions + 1), 1) : Number(affiliate.ctr) || 0;
  const confidence = Math.min(impressions / config.confidenceSampleSize, 1);
  const relativeCtr = combinedCtr - (Number(intentStats.averageCtr) || 0);
  ...
  const trendModifier = memory?.trendDirection === "up" ? 0.08 : memory?.trendDirection === "down" ? -0.08 : 0;

  return clampNumber(rawModifier + trendModifier, config.minModifier, config.maxModifier);
}
...
function getTrendDirection(previousCtr, currentCtr) {
...
function getTopAndWorstAffiliateMemory(affiliates) {
...
function updateAutonomousWeightsForIntent(intentType, intentState) {
  ...
  const currentAverageCtr = totalClicks / (totalImpressions + 1);
  const previousAverageCtr = Number(intentState.previousAverageCtr) || 0;
  const trendDirection = getTrendDirection(previousAverageCtr, currentAverageCtr);
  const weights = {
    ...getDefaultOptimizationWeights(),
    ...(intentState.weights || {})
  };
  ...
  const variantB = variantPerformance.find((variant) => variant.variant === "B");
...
function updateAutonomousOptimizationCycle(state) {
  Object.entries(state.intents || {}).forEach(([intentType, intentState]) => {
    updateAutonomousWeightsForIntent(intentType, intentState);
  });
}

function recordAffiliatePerformance({ intent, affiliate, eventType, optimizationContext = null }) {
  if (!affiliate || !intent || !["impression", "click"].includes(eventType)) {
    return;
  }

  const state = getAutonomousOptimizationState();
  const intentState = ensureIntentOptimizationState(state, intent);
  const affiliateKey = getAffiliateOptimizationKey(affiliate);

  if (!affiliateKey) {
    return;
  }

  const current = intentState.affiliates[affiliateKey] || {
    affiliate_id: affiliateKey,
    name: affiliate.name || "",
    impressions: 0,
    clicks: 0,
    ctr: 0,
  ...
  current.previousCtr = Number(current.ctr) || 0;
  ...
  current.ctr = current.impressions > 0 ? current.clicks / (current.impressions + 1) : 0;
  current.trendDirection = getTrendDirection(current.previousCtr, current.ctr);
  intentState.affiliates[affiliateKey] = current;

  const variant = optimizationContext?.variant;

  if (variant) {
    const variantState = intentState.variants[variant] || {
      impressions: 0,
      clicks: 0
    };

    if (eventType === "impression") {
      variantState.impressions += 1;
    }
    ...
    intentState.variants[variant] = variantState;
  }
...
function shouldExploreAffiliate(intentType, userMessage) {
  const sessionId = getConciergeSessionId();
...
async function sendMessage(text) {
  ...
  try {
    ...
    const mentionedEntityMatch = activeEntity ? normalizeTruthLayerMatchResult(activeEntity, 1) : findTruthLayerEntityInMessage(cleanText);
    entityMatchDebug = mentionedEntityMatch || entityMatchDebug;
    const mentionedEntity = activeEntity || (mentionedEntityMatch?.entity ? hydrateTruthLayerEntity(mentionedEntityMatch.entity.entityId, "message_match") : null);
    ...
    const finalResponse = await finalizeResponse({
      userMessage: cleanText,
      llmText: copy.disconnectedMessage,
      selectedIntent,
      entity: resolvedEntity,
      entityMatchConfidence: entityMatchDebug.confidence,
      entityResolutionSource,
